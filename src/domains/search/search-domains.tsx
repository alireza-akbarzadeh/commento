  ...
  return (
    <div>
      <div className="my-2 flex items-center gap-4 p-2.5">
        <Link href="/">
          <Image src="/svg/move-right.svg" width={17} height={14} alt="move-right" />
        </Link>
        <div className="relative flex w-full items-center">
          ...
          />
          {isFelidEmpty && (
            <Button className="cursor-pointer" onClick={handleClearSearch} asChild variant="ghost">
              <div>
                <Image src="/svg/close-fill.svg" width={16} height={16} alt="move-right" />
              </div>
            </Button>
          )}
        </div>
